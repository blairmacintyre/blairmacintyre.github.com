...
Worse, the article (and quoted experts) ignore the biggest obstacles to widespread adoption of interactive articles.  Not the capabilities of the tools or the technology (which is what the article focuses on) but serious issues like "how do authors avoide misleading readers?" and "how can simulations and interactive figures be reviewed and vetted?"
